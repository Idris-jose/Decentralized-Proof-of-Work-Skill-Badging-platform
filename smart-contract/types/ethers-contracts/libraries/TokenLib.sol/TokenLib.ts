...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../common.js"
  ...
  export interface TokenLibInterface extends Interface {
  ...
  export interface TokenLib extends BaseContract {
    
    connect(runner?: ContractRunner | null): TokenLib;
    waitForDeployment(): Promise<this>;

    interface: TokenLibInterface;
